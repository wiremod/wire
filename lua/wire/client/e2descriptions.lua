...
E2Helper.Descriptions["getLastSpawnpoint(e:)"] = "Returns the last spawnpoint entity a player has spawned at"
E2Helper.Descriptions["getSaveTable(e:)"] = "Returns a table of save values for an entity"
