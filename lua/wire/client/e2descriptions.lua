...
E2Helper.Descriptions["intersection(xv2xv2xv2xv2)"] = "Returns the intersection point of two lines. If two lines are collinear, then the intersection point is undefined. Z component means is points intersected"
