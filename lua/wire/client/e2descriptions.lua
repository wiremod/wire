...
E2Helper.Descriptions["getComponentName(e:)"] = "Returns the component name of another Wire entity. This is NOT the same as e:getName() function if called on E2 entity"
E2Helper.Descriptions["getName(e:)"] = "Return value depends on the type of entity provided, if it is E2 then it will return the name of another E2; otherwise, it will return the component name of another Wire entity instead"
E2Helper.Descriptions["setComponentName(e:s)"] = "Set the component name of another Wire entity. This is NOT the same as setName function if called on E2 entity"
E2Helper.Descriptions["setName(s)"] = "Set the name of the E2 itself"
E2Helper.Descriptions["setName(e:s)"] = "Depending on the type of entity provided, if it is E2 then it will set the name of another E2; otherwise, it will set the component name of another Wire entity instead"
