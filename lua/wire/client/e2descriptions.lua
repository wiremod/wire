...
E2Helper.Descriptions["gtimerCreate(snf)"] = "Creates a callback timer with the name S, delay of N seconds, 1 repeat(one-time timer) and callback function F. NOTE: If the timer finished running, it will not exist (and you won't be able to restart/configure it)"
E2Helper.Descriptions["gtimerRestart(s)"] = "Restarts the callback timer with the name S. Uses the same amount of repetitions/delay/callback function as when was created. NOTE: If the timer finished running, it will not exist (and you won't be able to restart/configure it)"
E2Helper.Descriptions["delay(nf)"] = "Creates a one-time callback timer with delay of N seconds and callback function F. Returns autogenerated name which you can use. Complete alias of gtimerCreate(nf). NOTE: If the timer finished running, it will not exist (and you won't be able to restart/configure it)"
E2Helper.Descriptions["gtimerExists(s)"] = "Returns 1 if a callback timer with the name S exists. 0 otherwise"
E2Helper.Descriptions["gtimerPause(s)"] = "Pauses the callback timer with the name S"--. Returns 1 if successful, 0 if the timer is already stopped"
E2Helper.Descriptions["gtimerResume(s)"] = "Resumes the callback timer with the name S"--. Returns 1 if successful, 0 if the timer is already running"
--E2Helper.Descriptions["gtimerToggle(s)"] = "Toggles the callback timer with the name S. Returns 1 if timer is now running, 0 otherwise"
E2Helper.Descriptions["gtimerRemove(s)"] = "Deletes the callback timer with the name S"
E2Helper.Descriptions["gtimerPurge()"] = "Deletes all callback timers"
E2Helper.Descriptions["gtimerRepsLeft(s)"] = "Returns the number of repetitions left for the callback timer with the name S"
E2Helper.Descriptions["gtimerTimeLeft(s)"] = "Returns the time left for the callback timer with the name S until the next execution"
E2Helper.Descriptions["gtimerList()"] = "Returns an array with all callback timers names"
