...
E2Helper.Descriptions["angle(xwl:s)"] = "Returns the angle from the specified address of linked component"
E2Helper.Descriptions["array(xwl:s)"] = "Returns the array from the specified address of linked component"
E2Helper.Descriptions["bone(xwl:s)"] = "Returns the bone from the specified address of linked component"
E2Helper.Descriptions["complex(xwl:s)"] = "Returns the complex number from the specified address of linked component"
E2Helper.Descriptions["entity(xwl:s)"] = "Returns the entity from the specified address of linked component"
E2Helper.Descriptions["gtable(xwl:s)"] = "Returns the gTable from the specified address of linked component"
...
E2Helper.Descriptions["hardQuota()"] = "Returns E2's hard quota"
...
E2Helper.Descriptions["fileMaxSize()"] = "Returns the maximum file size that can be uploaded or downloaded. Default is 100 KiB"
...
E2Helper.Descriptions["dsGetAngle()"] = "Returns the received angle"
E2Helper.Descriptions["dsGetArray()"] = "Returns the received array"
E2Helper.Descriptions["dsGetBone()"] = "Returns the received bone"
E2Helper.Descriptions["dsGetComplex()"] = "Returns the received complex number"
E2Helper.Descriptions["dsGetEntity()"] = "Returns the received entity"
E2Helper.Descriptions["dsGetMatrix()"] = "Returns the received matrix"
E2Helper.Descriptions["dsGetMatrix2()"] = "Returns the received 2x2 matrix"
E2Helper.Descriptions["dsGetMatrix4()"] = "Returns the received 4x4 matrix"
E2Helper.Descriptions["dsGetNumber()"] = "Returns the received number"
E2Helper.Descriptions["dsGetQuaternion()"] = "Returns the received quaternion"
E2Helper.Descriptions["dsGetRanger()"] = "Returns the received ranger"
E2Helper.Descriptions["dsGetString()"] = "Returns the received string"
E2Helper.Descriptions["dsGetTable()"] = "Returns the received table"
E2Helper.Descriptions["dsGetVector()"] = "Returns the received vector"
E2Helper.Descriptions["dsGetVector2()"] = "Returns the received 2D vector"
E2Helper.Descriptions["dsGetVector4()"] = "Returns the received 4D vector"
E2Helper.Descriptions["dsGetWirelink()"] = "Returns the received wirelink"
...
for k, v in pairs( types ) do
	local t = string.sub( v[2], 1, 1 )
	E2Helper.Descriptions["gDeleteAll"..k.."()"] = "Exactly the same as gRemoveAll"..v[1].."(S) (Except it removes in the group set by gSetGroup instead of using the group as an argument)"
	E2Helper.Descriptions["gDelete"..k.."(s)"] = "Removes and returns the variable of the "..v[2].." type at the index S in the current group"
	E2Helper.Descriptions["gDelete"..k.."(n)"] = "Exactly the same as gDelete"..k.."(N:toString())"
	E2Helper.Descriptions["gGet"..k.."(s)"] = "Gets a variable of the "..v[2].." type from index S in the current group"
	E2Helper.Descriptions["gGet"..k.."(n)"] = "Exactly the same as gGet"..k.."(N:toString())"
	E2Helper.Descriptions["gSet"..k.."(s"..t..")"] = "Sets a variable of the "..v[2].." type at index S in the current group"
	E2Helper.Descriptions["gSet"..k.."(n"..t..")"] = "Exactly the same as gSet"..k.."(N:toString(),"..v[2]..")"
end

types = {
	"Angles", "Arrays", "Bones", "Complexs", "Entitys", "Matrix2s", "Matrix4s", "Matrixs",
	"Numbers", "Rangers", "Tables", "Quaternions", "Strings", "Vector2s", "Vector4s", "Vectors", "Wirelinks"
}

for k, v in pairs( types ) do
	local type = string.lower( string.sub( v, 1, -2 ) )
	E2Helper.Descriptions["gRemoveAll"..v.."()"] = "Removes all variables of the "..type.." type in your non-shared table"
	E2Helper.Descriptions["gRemoveAll"..v.."(s)"] = "Removes all variables of the "..type.." type in your non-shared table in group S"
end
...
types = { "Angle", "Bone", "Complex", "Entity", "Matrix", "Number", "Quaternion",
		"String", "Table", "Vector", "Wirelink" }

for k, v in pairs( types ) do
	local t = string.lower( string.sub( v, 1, 1 ) )
	E2Helper.Descriptions["insert"..v.."(t:n"..t..")"] = "Inserts the variable at the specified position. Moves all other indexes up one step to compensate"
	E2Helper.Descriptions["insert"..v.."(r:n"..t..")"] = "Inserts the variable at the specified position. Moves all other indexes up one step to compensate"
end
...
E2Helper.Descriptions["angle(r:n)"] = "Returns the angle stored in the array under specified index"
E2Helper.Descriptions["bone(r:n)"] = "Returns the bone stored in the array under specified index"
E2Helper.Descriptions["complex(r:n)"] = "Returns the complex number stored in the array under specified index"
E2Helper.Descriptions["entity(r:n)"] = "Returns the entity stored in the array under specified index"
...
-- (de)serialization
E2Helper.Descriptions["glonDecode(s)"] = "Decodes string into an array"
E2Helper.Descriptions["glonDecodeTable(s)"] = "Decodes string into a table"
E2Helper.Descriptions["glonEncode(r)"] = "Encodes array into a string"
E2Helper.Descriptions["glonEncode(t)"] = "Encodes table into a string"
