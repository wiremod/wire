...
E2Helper.Descriptions["egpGlobalFiltering(xwl:n)"] = "Changes the texture filter used to draw all EGP Objects. Works only on EGP Screens. Number can be 0, 1(\"sharp\"), 2 or 3(\"blurry\"). See https://wiki.garrysmod.com/page/Enums/TEXFILTER"
...
E2Helper.Descriptions["egpFiltering(xwl:nn)"] = "Changes the texture filter used to draw the object. Works on objects that draw a material. Number can be 0, 1(\"sharp\"), 2 or 3(\"blurry\"). See https://wiki.garrysmod.com/page/Enums/TEXFILTER"
