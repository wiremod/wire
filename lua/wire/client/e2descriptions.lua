...
E2Helper.Descriptions["holoBonePos(nn)"] = "Returns the position offset of the given hologram bone"
E2Helper.Descriptions["holoBoneAng(nn)"] = "Returns the angle offset of the given hologram bone"
E2Helper.Descriptions["holoBonePos(ns)"] = "Returns the position offset of the given hologram named bone"
E2Helper.Descriptions["holoBoneAng(ns)"] = "Returns the angle offset of the given hologram named bone"
E2Helper.Descriptions["holoBonePos(nnv)"] = "Sets the position offset of the given hologram bone"
E2Helper.Descriptions["holoBoneAng(nna)"] = "Sets the angle offset of the given hologram bone"
E2Helper.Descriptions["holoBonePos(nsv)"] = "Sets the position offset of the given hologram named bone"
E2Helper.Descriptions["holoBoneAng(nsa)"] = "Sets the angle offset of the given hologram named bone"
E2Helper.Descriptions["holoBonePosW(nn)"] = "Returns the WORLD position of the given hologram bone"
E2Helper.Descriptions["holoBoneAngW(nn)"] = "Returns the WORLD angles of the given hologram bone"
E2Helper.Descriptions["holoBonePosW(ns)"] = "Returns the WORLD position of the given hologram named bone"
E2Helper.Descriptions["holoBoneAngW(ns)"] = "Returns the WORLD offset of the given hologram named bone"
