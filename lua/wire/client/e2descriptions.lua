...
E2Helper.Descriptions["keyClk()"] = "Returns the player that pressed/released the key if the E2 was triggered by runOnKey"
E2Helper.Descriptions["keyClk(e)"] = "Returns 1 or -1 if the E2 was triggered by the player pressing or releasing key"
