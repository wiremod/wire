...
E2Helper.Descriptions["holoBoneAng(nna)"] = "Sets the local angle of a bone using the number ID."
E2Helper.Descriptions["holoBoneAng(nsa)"] = "Sets the local angle of a bone using the string ID."
E2Helper.Descriptions["holoBoneAng(nn)"] = "Returns the world angle of a bone using the number ID."
E2Helper.Descriptions["holoBoneAng(ns)"] = "Returns the world angle of a bone using the string ID."
E2Helper.Descriptions["holoBoneParent(nn)"] = "Returns the number ID of the parent bone."
E2Helper.Descriptions["holoBoneParent(ns)"] = "Returns the string ID of the parent bone."
E2Helper.Descriptions["holoBonePos(nnv)"] = "Sets the local position of a bone using the number ID."
E2Helper.Descriptions["holoBonePos(nsv)"] = "Sets the local position of a bone using the string ID."
E2Helper.Descriptions["holoBonePos(nn)"] = "Returns the world position of a bone using the number ID."
E2Helper.Descriptions["holoBonePos(ns)"] = "Returns the world position of a bone using the string ID."
E2Helper.Descriptions["holoBones(n)"] = "Returns an array containing the names of every bone the given hologram has."
