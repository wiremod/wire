...
E2Helper.Descriptions["soundStop(nn)"] = "Fades the sound stored at the first input's integer index in the second input's amount of seconds"
E2Helper.Descriptions["soundStop(sn)"] = "Fades the sound stored at the string index in the integer input's amount of seconds"
E2Helper.Descriptions["soundPause(n)"] = "Pauses the sound stored at the integer index"
E2Helper.Descriptions["soundPause(s)"] = "Pauses the sound stored at the string index"
E2Helper.Descriptions["soundRemove(n)"] = "Clears the sound stored at the integer index"
E2Helper.Descriptions["soundRemove(s)"] = "Clears the sound stored at the string index"
...
E2Helper.Descriptions["soundPitch(nn)"] = "soundPitch(integer Index, Pitch), where Pitch is a number between 0 and 300. Default Pitch is 100"
E2Helper.Descriptions["soundPitch(sn)"] = "soundPitch(string Index, Pitch), where Pitch is a number between 0 and 300. Default Pitch is 100"
E2Helper.Descriptions["soundPitch(nnn)"] = "soundPitch(integer Index, Pitch, FadeTime), where Pitch is a number between 0 and 300 Default Pitch is 1"
E2Helper.Descriptions["soundPitch(snn)"] = "soundPitch(string Index, Pitch, FadeTime), where Pitch is a number between 0 and 300. Default Pitch is 1"
E2Helper.Descriptions["soundFadeDistance(nnn)"] = "soundFadeDistance(integer Index, Min, Max), where Min sets the distance within which the volume is highest, and Max sets when the sound will cut off."
E2Helper.Descriptions["soundFadeDistance(snn)"] = "soundFadeDistance(string Index, Min, Max),where Min sets the distance within which the volume is highest, and Max sets when the sound will cut off."
E2Helper.Descriptions["soundLoop(nn)"] = "soundLoop(integer Index, Boolean), enables looping, default 1."
E2Helper.Descriptions["soundLoop(sn)"] = "soundLoop(string Index, Boolean), enables looping, default 1."
E2Helper.Descriptions["soundTimePosition(nn)"] = "soundTimePosition(integer Index, Time), sets the playback position to Time seconds"
E2Helper.Descriptions["soundTimePosition(sn)"] = "soundTimePosition(string Index, Time), sets the playback position to Time seconds"
