...
-- mtables
E2Helper.Descriptions["mtable"] = "Returns an mtable with the values specified in the array-part."
E2Helper.Descriptions["toMTable(t:)"] = "Converts the table into an mtable. (Note that there is no Array:toMTable() function because E2 arrays do not save typeids)"
E2Helper.Descriptions["clear(xmt:)"] = "Clears the mtable."
E2Helper.Descriptions["count(xmt:)"] = "Returns the number of entries in the mtable. Does not add the entries in subtables."
E2Helper.Descriptions["depth(xmt:)"] = "Returns the depth at which the table is in, relative to its parents."
E2Helper.Descriptions["flip(xmt:)"] = "Returns a flipped copy of the mtable. Only affects string values in the array part and number values in the table part."
E2Helper.Descriptions["typeids(xmt:)"] = "Returns a new mtable with the typeids of the mtable"
E2Helper.Descriptions["remove(xmt:n)"] = "Removes the specified entry from the array-part."
E2Helper.Descriptions["remove(xmt:s)"] = "Removes the specified entry from the table-part."
E2Helper.Descriptions["clipToTypeid(xmt:s)"] = "Removes all entries not of the specified type."
E2Helper.Descriptions["clipFromTypeid(xmt:s)"] = "Removes all entries of the specified type."
E2Helper.Descriptions["pop(xmt:)"] = "Removes the last entry in the array-part."
E2Helper.Descriptions["min(xmt:)"] = "Returns the smallest numerical entry in the array-part."
E2Helper.Descriptions["max(xmt:)"] = "Returns the largest numerical entry in the array-part."
E2Helper.Descriptions["minIndex(xmt:)"] = "Returns the index of the smallest numerical entry in the array-part."
E2Helper.Descriptions["maxIndex(xmt:)"] = "Returns the index of the largest numerical entry in the array-part."
E2Helper.Descriptions["typeidsArray(xmt:)"] = "Returns an array with the typeids of the array-part of the mtable."
E2Helper.Descriptions["toArray(xmt:)"] = "Converts the mtable into an array. (Note that there is no R:toMTable() function because E2 arrays do not save typeids)"
E2Helper.Descriptions["findToMTable()"] = "Inserts the finds from an entity discovery event into an mtable's array-part and returns it. (Basically the same as findToArray())"
E2Helper.Descriptions["toTable(xmt:)"] = "Converts the mtable into a table."
E2Helper.Descriptions["typeidsTable(xmt:)"] = "Returns a table with the typeids of the table-part of the mtable."
E2Helper.Descriptions["clone(xmt:)"] = "Returns a copy of the mtable."
E2Helper.Descriptions["concat(xmt:)"] = "Concatenates the array-part of the mtable."
E2Helper.Descriptions["concat(xmt:s)"] = "Concatenates the array-part of the mtable, with a string delimiter."
E2Helper.Descriptions["toString(xmt:)"] = "Formats the mtable as a human-readable string."
E2Helper.Descriptions["id(xmt:)"] = "Returns the unique ID of the table."
end
