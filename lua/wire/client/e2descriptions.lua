...
E2Helper.Descriptions["setClip1(e:n)"] = "Sets the amount of ammo in the primary clip of weapon E"
E2Helper.Descriptions["clip2Size(e:)"] = "Returns the maximum size of the secondary clip"
E2Helper.Descriptions["setClip2(e:n)"] = "Sets the amount of ammo in the secondary clip of weapon E"
E2Helper.Descriptions["giveWeapon(e:s)"] = "Gives player E the weapon with class S"
E2Helper.Descriptions["giveWeapon(e:sn)"] = "Gives player E the weapon with class S. If N is not 0, the weapon will be given with full ammo"
E2Helper.Descriptions["selectWeapon(e:s)"] = "Sets the active weapon with class S on player E"
E2Helper.Descriptions["giveAmmo(e:ns)"] = "Gives the player E N amount of ammo of type S"
E2Helper.Descriptions["giveAmmo(e:nsn)"] = "Gives the player E N amount of ammo of type S. If N is not 0, the pop-up will not appear"
E2Helper.Descriptions["setAmmo(e:ns)"] = "Sets the amount of ammo of type S on player E to N"
E2Helper.Descriptions["removeAmmo(e:ns)"] = "Removes N amount ammo of type S from player E"
E2Helper.Descriptions["removeAllAmmo(e:)"] = "Removes all ammo from the player E"
E2Helper.Descriptions["stripWeapon(e:s)"] = "Removes the weapon with class S from player E"
E2Helper.Descriptions["stripWeapons(e:)"] = "Removes all weapons from player E"
