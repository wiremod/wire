...
E2Helper.Descriptions["velGroundSpeed(e:)"] = "Gets the entity's ground speed velocity, which is based on the entity's walk/run speed and/or the ground speed of their sequence"
...
E2Helper.Descriptions["mapCreationID(e:)"] = "Returns the map creation id of the map entity, which is always the same between sessions."
E2Helper.Descriptions["creationID(e:)"] = "Returns the entity creation id, which always increments to 10 million and then resets to 0."
...
E2Helper.Descriptions["getEffects(e:)"] = "Returns a bit flag of all engine effect flags of an entity (_EF)"
E2Helper.Descriptions["getNoDraw(e:)"] = "Returns if the entity's rendering and transmitting has been disabled"
E2Helper.Descriptions["isEffectActive(e:n)"] = "Returns whether an entity has engine effect applied or not (_EF)"
E2Helper.Descriptions["getGravity(e:)"] = "Return the gravity multiplier of the entity"
E2Helper.Descriptions["getGroundEntity(e:)"] = "Returns the object the entity is standing on"
E2Helper.Descriptions["getSolid(e:)"] = "Returns solid type of an entity (_SOLID)"
E2Helper.Descriptions["isGravityEnabled(e:)"] = "Is gravity enabled for the entity?"
E2Helper.Descriptions["isSolid(e:)"] = "Returns if the entity is solid or not. Very useful for determining if the entity is a trigger or not"
...
E2Helper.Descriptions["isAlive(e:)"] = "Is the entity alive?"
...
E2Helper.Descriptions["fromModelBone(e:n)"] = "Returns the bone based on the corresponding model bone"
E2Helper.Descriptions["getBoneName(b:)"] = "Returns the name of the bone according to its model"
...
E2Helper.Descriptions["toModelBone(b:)"] = "Returns the model bone index of the bone"
...
E2Helper.Descriptions["timerStop(s)"] = "Alias of stoptimer(s). " .. E2Helper.Descriptions["stoptimer(s)"]
E2Helper.Descriptions["timerRemove(s)"] = "Alias of stoptimer(). " .. E2Helper.Descriptions["stoptimer(s)"]
...
E2Helper.Descriptions["getBodygroupName(e:n)"] = "Group ID\nReturns the bodygroup name of given Group ID"
...
E2Helper.Descriptions["getMaterialType(e:)"] = "Returns the surface material type of an entity"
...
E2Helper.Descriptions["getMoveType(e:)"] = "Returns the movetype of an entity"
...
E2Helper.Descriptions["setRenderMode(e:n)"] = "Sets the render mode of the entity (_RENDERMODE)"
E2Helper.Descriptions["getRenderMode(e:)"] = "Returns the render mode of the entity (_RENDERMODE)"
E2Helper.Descriptions["setRenderFX(e:n)"] = "Sets the renderfx of the entity (_RENDERFX)"
E2Helper.Descriptions["getRenderFX(e:)"] = "Returns the renderfx of the entity (_RENDERFX)"
...
E2Helper.Descriptions["holoRenderFX(nn)"] = "Changes the RenderFX for a hologram (_RENDERFX)"
