...
E2Helper.Descriptions["egp3DTracker"] = "Creates a 3D tracker object at specified world position"
...
E2Helper.Descriptions["egpBox"] = "Creates a box. First 2D vector is the position, second is size"
E2Helper.Descriptions["egpBoxOutline"] = "Creates an outline box. First 2D vector is the position, second is size"
E2Helper.Descriptions["egpCircle"] = "Creates a circle. First 2D vector is the position, second is size"
E2Helper.Descriptions["egpCircleOutline"] = "Creates an outline circle. First 2D vector is the position, second is size"
E2Helper.Descriptions["egpLine"] = "Creates a line. First 2D vector is the start position, second is end position"
E2Helper.Descriptions["egpLineStrip"] = "Creates a curve with specified points as 2D/4D vectors (x,y)/(x,y,u,v)"
...
E2Helper.Descriptions["egpPoly"] = "Creates a polygon with specified points as 2D/4D vectors (x,y)/(x,y,u,v)"
...
E2Helper.Descriptions["egpPolyOutline"] = "Creates a outline polygon with specified points as 2D/4D vectors (x,y)/(x,y,u,v)"
E2Helper.Descriptions["egpRoundedBox"] = "Creates a rounded box. First 2D vector is the position, second is size"
E2Helper.Descriptions["egpRoundedBoxOutline"] = "Creates a rounded outline box. First 2D vector is the position, second is size"
E2Helper.Descriptions["egpText"] = "Creates a text object"
E2Helper.Descriptions["egpTextLayout"] = "Creates a text layout object"
E2Helper.Descriptions["egpTriangle"] = "Creates a triangle with specified vertices"
E2Helper.Descriptions["egpTriangleOutline"] = "Creates a outline triangle with specified vertices"
...
E2Helper.Descriptions["egpCreate(xwl:s)"] = "Creates an object prototype of the specified type. Note that you have to initialize the object before it's sent to the screen."
E2Helper.Descriptions["egpCreate(xwl:sn)"] = "Creates an object prototype of the specified type at the index. Note that you have to initialize the object before it's sent to the screen."
E2Helper.Descriptions["initialize(xeo:)"] = "Initializes an object prototype."
E2Helper.Descriptions["initialize(xeo:t)"] = "Initializes an object prototype with the provided arguments."
E2Helper.Descriptions["modify(xeo:t)"] = "Modifies an object with the provided arguments."

E2Helper.Descriptions["egpAlign(xeo:n)"] = "Changes the horizontal alignment. Works on: text and text layout. Number can be 0, 1 or 2"
E2Helper.Descriptions["egpAlign(xeo:nn)"] = "Changes the horizontal and vertical alignment. Works on: text and text layout. Numbers can be 0, 1 or 2"
E2Helper.Descriptions["egpAlpha(xeo:n)"] = "Changes the alpha (transparency) of an object"
E2Helper.Descriptions["egpAngle(xeo:n)"] = "Changes the angle of the object"
E2Helper.Descriptions["egpAngle(xeo:xv2xv2n)"] = "Rotates the object around the first vec2 with the second vec2 as offset at angle N"
E2Helper.Descriptions["egpColor(xeo:nnnn)"] = "Changes the color and alpha of the object"
...
E2Helper.Descriptions["egpFidelity(xeo:n)"] = "Changes the fidelity of the object (the number of vertices the circle will use)"
E2Helper.Descriptions["egpFont(xeo:sn)"] = "Changes the font and size of the text object"
E2Helper.Descriptions["egpMaterial(xeo:s)"] = "Changes the material of the object"
E2Helper.Descriptions["egpMaterialFromScreen(xeo:e)"] = "Sets the material of the object to a current snapshot of the target screen. Note that this only works for players which see both the egp as well the target screen at that time"
E2Helper.Descriptions["egpOrder(xeo:n)"] = "Sets the order at which the object will be rendered"
E2Helper.Descriptions["egpParent(xeo:e)"] = "Parents the 3D tracker object to an entity"
E2Helper.Descriptions["egpParent(xeo:n)"] = "Parents the object to another object. Parented objects' positions are local to their parent"
E2Helper.Descriptions["egpParent(xeo:xeo)"] = "Parents the object to another object. Parented objects' positions are local to their parent"
...
E2Helper.Descriptions["egpParentToCursor(xeo:)"] = "Parents the object to player's cursor"
E2Helper.Descriptions["egpParentIndex(xeo:)"] = "Returns the index of the parent object"
E2Helper.Descriptions["egpUnParent(xeo:)"] = "Un-parents the object"
E2Helper.Descriptions["egpPos(xeo:)"] = "Returns the position of the object"
E2Helper.Descriptions["egpPosAng(xeo:)"] = "Returns the position (x, y) and angle (z) of the object"
E2Helper.Descriptions["egpPos(xeo:nnnn)"] = "Changes the position of the start and end of a line object, otherwise acts normally."
E2Helper.Descriptions["egpPos(xeo:v)"] = "Changes the world position of the 3D tracker object"
E2Helper.Descriptions["egpRadius(xeo:n)"] = "Changes the corner radius of the rounded box object"
E2Helper.Descriptions["egpSetText(xeo:s)"] = "Changes the text of the text object"
E2Helper.Descriptions["egpSetText(xeo:ssn)"] = "Changes the text, font, and text size of the text object"
E2Helper.Descriptions["egpSetVertices"] = "Sets the vertices of the object. Can use vector2 or vector4 for vertices."
E2Helper.Descriptions["egpSize(xeo:)"] = "Returns the size of the object"
E2Helper.Descriptions["egpSize(xeo:n)"] = "Changes the size of the text/line/outline object"
E2Helper.Descriptions["isLoaded(xeo:)"] = "Returns 1 if the object is initialized."
E2Helper.Descriptions["unload(xeo:)"] = "Removes an object from the screen but keeps its data intact. You can still modify an unloaded object. Reload it by calling :initialize() on it."
...
E2Helper.Descriptions["egpObjectContainsPoint(xeo:xv2)"] = "Returns 1 if the object with specified index contains the specified point"
E2Helper.Descriptions["egpFiltering(xeo:n)"] = "Changes the texture filter used to draw the object. Works on objects that draw a material. See _TEXFILTER constants (POINT=sharp, ANISOTROPIC=blurry/default)"
