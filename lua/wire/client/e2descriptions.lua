...
E2Helper.Descriptions["getComponentName()"] = "Get the component name of the E2 itself"
E2Helper.Descriptions["getComponentName(e:)"] = "Get the component name of another Wire entity"
E2Helper.Descriptions["getName()"] = "Get the name of the E2 itself"
E2Helper.Descriptions["getName(e:)"] = "Get the name of another E2"
E2Helper.Descriptions["setComponentName(s)"] = "Set the component name of the E2 itself"
E2Helper.Descriptions["setComponentName(e:s)"] = "Set the component name of another Wire entity"
E2Helper.Descriptions["setName(s)"] = "Set the name of the E2 itself"
E2Helper.Descriptions["setName(e:s)"] = "Depending on the type of entity, if it is E2 then it will set the name of another E2; otherwise, it will set component name of another Wire entity"
