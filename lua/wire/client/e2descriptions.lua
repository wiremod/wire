...
E2Helper.Descriptions["egpConnectedUsers(xwl:)"] = "Returns an array with every player that is connected to this EGP (for EGP HUDs)"
...
E2Helper.Descriptions["egpOrderAbove(xwl:nn)"] = "Sets the object to render above (after) the second object"
E2Helper.Descriptions["egpOrderBelow(xwl:nn)"] = "Sets the object to render below (before) the second object"
...
E2Helper.Descriptions["egpHudToggle"] = "Toggles the HUD on/off"
