...
E2Helper.Descriptions["egpAlpha(xeo:)"] = "Returns the alpha of the object"
...
E2Helper.Descriptions["egpColor(xeo:)"] = "Returns the color of the object as 3D vector"
...
E2Helper.Descriptions["egpColor4(xeo:)"] = "Returns the color of the object as 4D vector (including alpha)"
E2Helper.Descriptions["egpFidelity(xeo:)"] = "Returns the fidelity of the object"
...
E2Helper.Descriptions["egpFont(xeo:s)"] = "Changes the font of the text object"
E2Helper.Descriptions["egpMaterial(xeo:)"] = "Returns the material of the object"
...
E2Helper.Descriptions["egpOrder(xeo:)"] = "Returns the order at which the object is rendered"
E2Helper.Descriptions["egpParent(xeo:)"] = "Returns the index of the parent object"
...
E2Helper.Descriptions["egpParent(xeo:xeoxeo)"] = "Parents the object to another object. Parented objects' positions are local to their parent"
...
E2Helper.Descriptions["egpPos(xeo:xv2)"] = "Changes the position of the object"
...
E2Helper.Descriptions["egpRadius(xeo:)"] = "Returns the corcner radius of the rounded box object"
E2Helper.Descriptions["egpRemove(xeo:)"] = "Removes the object from the screen"
E2Helper.Descriptions["egpRemove(xwl:xeo)"] = "Removes the object from the screen"
...
E2Helper.Descriptions["egpSize(xeo:xv2)"] = "Changes the size of the object"
E2Helper.Descriptions["egpSizeNum(xeo:)"] = "Returns the size of the text/line/outline object"
E2Helper.Descriptions["egpTrackerParent(xeo:)"] = "Returns the parent entity of the 3D tracker object"

E2Helper.Descriptions["egpCopy(xwl:nxeo)"] = "Copies the settings of the second object into the first. If the first object does not exist, it's created"
E2Helper.Descriptions["egpConnectedUsers(xwl:)"] = "Returns an array of players connected to the EGP"
E2Helper.Descriptions["egpCursor(xwl:e)"] = "Returns the specified player's aim position on the screen"
E2Helper.Descriptions["egpGlobalPos(xeo:)"] = "Returns the \"global\" (= it takes the parents' positions into consideration) position as a 3D vector. X and Y being the 2D X,Y coordinates, while Z is the angle"
E2Helper.Descriptions["egpGlobalVertices(xeo:)"] = "Returns an array of 2D vectors with the \"global\" positions of the vertices in the object"
...
E2Helper.Descriptions["egpVertices(xeo:)"] = "Returns an array of the vertices of the object"
