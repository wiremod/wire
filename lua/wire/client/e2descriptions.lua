...
E2Helper.Descriptions["getComponentName(e:)"] = "Returns the component name of Wire-compatible entity"
E2Helper.Descriptions["getName(e:)"] = "Returns the name of another E2"
E2Helper.Descriptions["setComponentName(e:s)"] = "Set the component name of Wire-compatible entity (limited to 199 chars). Returns 1 if the component name was changed; otherwise, it will return 0 to indicate a failure"
E2Helper.Descriptions["setName(s)"] = "Set the name of the E2 itself. Returns 1 if the E2 name was changed; otherwise, it will return 0 to indicate a failure"
E2Helper.Descriptions["setName(e:s)"] = "Set the name of another E2. Returns 1 if the E2 name was changed; otherwise, it will return 0 to indicate a failure"
