...
E2Helper.Descriptions["getSeatViewInfo(e:n)"] = "Returns the view table with position, angle and fov"
...
E2Helper.Descriptions["getWheelHeight(e:n)"] = "Returns the total wheel height."
