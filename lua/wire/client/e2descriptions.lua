...
E2Helper.Descriptions["applyForce(v)"] = "Applies force to the E2 chip according to the given vector's direction and magnitude. Note: This function eventually enables collisions on a entity's contraption, if you have problems with collisions then use applyOffsetForce instead."
E2Helper.Descriptions["applyForce(e:v)"] = "Applies force to the entity according to the given vector's direction and magnitude. Note: This function eventually enables collisions on a entity's contraption, if you have problems with collisions then use applyOffsetForce instead."
