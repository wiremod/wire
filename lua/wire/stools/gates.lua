...
if CLIENT then
	...
	language.Add( "Tool_wire_gate_arithmetic_0", "Primary: Create/Update Arithmetic Gate, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
	...
	language.Add( "Tool_wire_gate_ranger_0", "Primary: Create/Update Ranger Data Gate, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
	...
	language.Add( "Tool_wire_gate_vector_0", "Primary: Create/Update Vector Gate, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
	...
	language.Add( "Tool_wire_gate_angle_0", "Primary: Create/Update Angle Gate, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
	...
	language.Add( "Tool_wire_gate_string_0", "Primary: Create/Update String Gate, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
	...
	language.Add( "Tool_wire_gate_entity_0", "Primary: Create/Update Entity Gate, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
	...
	language.Add( "Tool_wire_gate_comparison_0", "Primary: Create/Update Comparison Gate, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
	...
	language.Add( "Tool_wire_gate_array_0", "Primary: Create/Update Duplexer Chip, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
	...
	language.Add( "Tool_wire_gate_logic_0", "Primary: Create/Update Logic Gate, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
	...
	language.Add( "Tool_wire_gate_bitwise_0", "Primary: Create/Update Bitwise Gate, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
	...
	language.Add( "Tool_wire_gate_memory_0", "Primary: Create/Update Memory Chip, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
	...
	language.Add( "Tool_wire_gate_selection_0", "Primary: Create/Update Selection Chip, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
	...
	language.Add( "Tool_wire_gate_time_0", "Primary: Create/Update Time Chip, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
	...
	language.Add( "Tool_wire_gate_trig_0", "Primary: Create/Update Trig Gate, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
	...
	language.Add( "Tool_wire_gates_0", "Primary: Create/Update Gate, Secondary: Rotate the gate 45 degrees, Reload: Unparent gate (if parented)" )
...
local function buildTOOL( s_name, s_def, deflimit )
	...
	function TOOL:GetGhostAngle( trace )
		return self:GetAngle( trace )
	end

	if (SinglePlayer()) then -- This is necessary because the client side RightClick function does not run in single player
		function TOOL:RightClick( trace )
			self:GetOwner():ConCommand( s_mode .. "_angleoffset " .. (self:GetClientNumber( "angleoffset" ) + 45) % 360 )
		end
	end

	if CLIENT then
		local lastuse = 0 -- this is necessary because it sometimes ran twice
		function TOOL:RightClick( trace )
			if (lastuse > CurTime()) then return end
			lastuse = CurTime() + 0.1
			RunConsoleCommand( s_mode .. "_angleoffset", (self:GetClientNumber( "angleoffset" ) + 45) % 360 )
		end
		...
		TOOL.BuildCPanel = function(panel)
			...
			local angleoffset = panel:NumSlider( "#WireGatesTool_angleoffset",s_mode.."_angleoffset", 0, 360, 0 )
