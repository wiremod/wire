...
function ENT:TriggerInput( name, value )
	if name == "Kick the bastard out of keyboard" then
		...
		timer.Simple(0.1, function() if IsValid(self) then self.Locked = (value ~= 0) self:PlayerDetach() end ) --It was kicking at the same time as giving output - added tiny delay fixing that race condition
