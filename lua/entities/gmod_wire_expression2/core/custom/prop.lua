...
e2function entity propSpawn(string model, vector pos, number frozen)
	return PropCore.ValidAction(self, nil, "spawn") and PropCore.CreateProp(self,model,Vector(pos[1],pos[2],pos[3]),self.entity:GetAngles(),frozen) or NULL
end

e2function entity propSpawn(entity template, vector pos, number frozen)
	return PropCore.ValidAction(self, nil, "spawn") and IsValid(template) and PropCore.CreateProp(self,template:GetModel(),Vector(pos[1],pos[2],pos[3]),self.entity:GetAngles(),frozen) or NULL
end
...
e2function entity propSpawn(entity template, angle rot, number frozen)
	return PropCore.ValidAction(self, nil, "spawn") and IsValid(template) and PropCore.CreateProp(self,template:GetModel(),self.entity:GetPos()+self.entity:GetUp()*25,Angle(rot[1],rot[2],rot[3]),frozen) or NULL
end

e2function entity propSpawn(string model, vector pos, angle rot, number frozen)
	return PropCore.ValidAction(self, nil, "spawn") and PropCore.CreateProp(self,model,Vector(pos[1],pos[2],pos[3]),Angle(rot[1],rot[2],rot[3]),frozen) or NULL
end
...
e2function entity seatSpawn(string model, number frozen)
	return PropCore.ValidAction(self, nil, "spawn") and PropCore.CreateProp(self,model,self.entity:GetPos()+self.entity:GetUp()*25,self.entity:GetAngles(),frozen,true) or NULL
end
...
e2function number entity:propGetFriction()
	return PropCore.ValidAction(self, this, "friction") and this:GetFriction() or 0
end
