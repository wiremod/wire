...
E2Helper.Descriptions["trackCollision(ef)"] = "Starts tracking collisions for the entity, will call the provided callback function, then fire event entityCollision when they occur.\nDoes not track when players or vehicles hit world, only other entities.\nMay track without event entityCollision\nPassed callback function needs argument signature of (eexcd), aka (entity, entity, collision)\nReturns 1 on success or 0 on error in non-strict."
