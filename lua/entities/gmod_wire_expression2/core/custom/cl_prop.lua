...
E2Helper.Descriptions["seatSpawn(svans)"] = E2Helper.Descriptions .. " String seatType, determines what animations the seat will have. For example phx_seat2 and phx_seat3 will have Jeep and Airboat animations."
