...
E2Helper.Descriptions["propSpawn(en)"] = E2Helper.Descriptions["propSpawn(sn)"]
E2Helper.Descriptions["propSpawn(svn)"] = E2Helper.Descriptions["propSpawn(sn)"]
E2Helper.Descriptions["propSpawn(evn)"] = E2Helper.Descriptions["propSpawn(sn)"]
E2Helper.Descriptions["propSpawn(san)"] = E2Helper.Descriptions["propSpawn(sn)"]
E2Helper.Descriptions["propSpawn(ean)"] = E2Helper.Descriptions["propSpawn(sn)"]
E2Helper.Descriptions["propSpawn(svan)"] = E2Helper.Descriptions["propSpawn(sn)"]
E2Helper.Descriptions["propSpawn(evan)"] = E2Helper.Descriptions["propSpawn(sn)"]
E2Helper.Descriptions["seatSpawn(sn)"] = "Spawn a remodeled prop_vehicle_prisoner_pod"
...
E2Helper.Descriptions["propDelete(e:)"] = "Removes the given entity(s). Returns how may are deleted."
E2Helper.Descriptions["propDelete(t:)"] = E2Helper.Descriptions["propDelete(e:)"]
E2Helper.Descriptions["propDelete(r:)"] = E2Helper.Descriptions["propDelete(e:)"]
