...
E2Helper.Descriptions["seatSpawn(sns)"] = "Last string refers to seat type, Valid types are Seat_Airboat, Seat_Pod and Seat_Jeep"
E2Helper.Descriptions["seatSpawn(svan)"] = E2Helper.Descriptions["seatSpawn(sn)"]
E2Helper.Descriptions["seatSpawn(svans)"] = "Last string refers to seat type, Valid types are Seat_Airboat, Seat_Pod and Seat_Jeep"
