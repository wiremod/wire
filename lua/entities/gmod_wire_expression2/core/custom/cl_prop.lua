...
E2Helper.Descriptions["propDissolve(e:)"] = "Dissolves an entity"
E2Helper.Descriptions["propDissolve(e:n)"] = "Dissolve an entity with specified type (_ENTITY_DISSOLVE)"
E2Helper.Descriptions["propDissolve(e:nn)"] = "Dissolves an entity with the specified type (_ENTITY_DISSOLVE) and magnitude"
