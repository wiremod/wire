...
E2Helper.Descriptions["customPropSpawn(t)"] = "Spawns a custom prop with the given table of format table(1 = array(vec(), ...), 2 = array(vec(), ...), ...) where each array is a convex."
E2Helper.Descriptions["customPropSpawn(tv)"] = E2Helper.Descriptions["customPropSpawn(t)"] .. "A vector position, where to spawn the prop."
E2Helper.Descriptions["customPropSpawn(ta)"] = E2Helper.Descriptions["customPropSpawn(t)"] .. "An angle rotation, how to rotate the prop."
E2Helper.Descriptions["customPropSpawn(tva)"] = E2Helper.Descriptions["customPropSpawn(t)"] .. "A vector position, where to spawn the prop, and an angle rotation, how to rotate the prop."
E2Helper.Descriptions["customPropSpawn(tvan)"] = E2Helper.Descriptions["customPropSpawn(t)"] .. "A vector position, where to spawn the prop, an angle rotation, how to rotate the prop, and a number frozen/unfrozen."
E2Helper.Descriptions["customPropCanCreate()"] = "Returns 1 if you can create a custom prop, 0 otherwise."
E2Helper.Descriptions["customPropCanSpawnIn()"] = "Returns in seconds how long until you can spawn another custom prop, 0 if you can spawn now."
E2Helper.Descriptions["customPropIsEnabled()"] = "Returns 1 if custom props are enabled, 0 otherwise."
E2Helper.Descriptions["customPropGetDelay()"] = "Returns the delay in seconds between spawning custom props."
E2Helper.Descriptions["customPropsLeft()"] = "Returns how many custom props you can still spawn."
E2Helper.Descriptions["customPropsMax()"] = "Returns the maximum amount of custom props you can spawn."
E2Helper.Descriptions["customPropConvexesMax()"] = "Returns the maximum amount of convexes a custom prop can have."
E2Helper.Descriptions["customPropVerticesMax()"] = "Returns the maximum amount of vertices a convex in a custom prop can have."
E2Helper.Descriptions["customPropMinVertexDistance()"] = "Returns the minimum distance two vertices in a convex can have."
E2Helper.Descriptions["customPropHullSizeMax()"] = "Returns the maximum hull size of a custom prop."
E2Helper.Descriptions["customPropsSpawned()"] = "Returns how many custom props you have currently spawned."
