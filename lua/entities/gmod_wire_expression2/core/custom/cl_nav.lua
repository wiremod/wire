...
E2Helper.Descriptions["navNearestMesh(v,n)"] = "Returns the navmesh closest to the specified vector. Any number other than 0 will force it to check line of sight to that navmvesh. More expensive than navmesh(v), but usually guaranteed a return."
