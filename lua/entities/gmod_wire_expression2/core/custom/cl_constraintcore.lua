...
E2Helper.Descriptions["hydraulic(nevevnnnsnn)"] = "Creates a hydraulic constraint with a referenceid, between two entities, at vectors local to each, with constant, damping, relative damping and stretch only"E2Helper.Descriptions["rope"] = "Creates a rope constraint with a referenceid, between two entities, at vectors local to each"
