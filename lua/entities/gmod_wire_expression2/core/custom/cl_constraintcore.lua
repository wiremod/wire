...
E2Helper.Descriptions["ballsocket(evevvvv)"] = "Creates an AdvBallsocket constraint between two entities at a vector local to each entity, using the specified mins, maxs and frictions"
...
E2Helper.Descriptions["ballsocket(evevvvvn)"] = "Creates an AdvBallsocket constraint between two entities at a vector local to each entity, using the specified mins, maxs, frictions, rotateonly"
