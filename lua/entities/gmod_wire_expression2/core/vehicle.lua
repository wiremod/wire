--print("Loading Vehicle-Entity support E2 extension...")

if not E2Lib.GetExtensionStatus("vehicle") then
	hook.Remove("PlayerLeaveVehicle", "E2SetVehicleExitPoint")
	hook.Remove("EntityRemoved", "E2RemoveVehicleExitPoint")
end

E2Lib.RegisterExtension("vehicle", true, "todo description.", "todo warning.")
...
--registerCallback("construct", function(...) print("construct", ...) end)

-- TODO: Possibly remove exit-point data from vehicles assigned by E2 chip (when it is removed)?
--registerCallback("destruct", function(...) print("destruct", ...) end)

--registerCallback("postexecute", function(...) print("postexecute", ...) end)

--print("Vehicle-Entity support E2 extension loaded.")
