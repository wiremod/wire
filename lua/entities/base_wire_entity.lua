...
if CLIENT then
	...
	function ENT:DrawWorldTipBody( pos )
		...
		draw.DrawText( data.txt, "PIXEL.UI.FrameTitle", pos.center.x, pos.min.y + edgesize/2, Color(255,255,255,255), TEXT_ALIGN_CENTER )
	end
	...
	function ENT:DrawWorldTip()
		...
		if info_requires_multiline then
			draw.DrawText( class, "PIXEL.UI.FrameTitle", pos.center.x, offset + 8, Color(255,255,255,255), TEXT_ALIGN_CENTER )
			draw.DrawText( name, "PIXEL.UI.FrameTitle", pos.center.x, offset + h_class + 16, Color(255,255,255,255), TEXT_ALIGN_CENTER )
		else
			draw.DrawText( class, "PIXEL.UI.FrameTitle", pos.min.x + edgesize, offset + 16, Color(255,255,255,255) )
			draw.DrawText( name, "PIXEL.UI.FrameTitle", pos.min.x + pos.size.w - w_name - edgesize, offset + 16, Color(255,255,255,255) )
		end
	end
