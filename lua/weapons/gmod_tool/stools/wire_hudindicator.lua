...
if ( CLIENT ) then
    language12.Add( "Tool_wire_hudindicator_name", "Hud Indicator Tool (Wire)" )
    language12.Add( "Tool_wire_hudindicator_desc", "Spawns a Hud Indicator for use with the wire system." )
    language12.Add( "Tool_wire_hudindicator_0", "Primary: Create/Update Hud Indicator Secondary: Hook/Unhook someone else's Hud Indicator Reload: Link Hud Indicator to vehicle" )
	language12.Add( "Tool_wire_hudindicator_1", "Now use Reload on a vehicle to link this Hud Indicator to it, or on the same Hud Indicator to unlink it" )
    /* Don't need this stuff
	language12.Add( "ToolWireIndicator_Model", "Model:" )
	language12.Add( "ToolWireIndicator_a_value", "A Value:" )
	language12.Add( "ToolWireIndicator_a_colour", "A Colour:" )
	language12.Add( "ToolWireIndicator_b_value", "B Value:" )
	language12.Add( "ToolWireIndicator_b_colour", "B Colour:" )
	language12.Add( "ToolWireIndicator_Material", "Material:" )
	language12.Add( "ToolWireIndicator_90", "Rotate segment 90" )
	language12.Add( "sboxlimit_wire_indicators", "You've hit indicators limit!" )
	*/
	language12.Add( "undone_wirehudindicator", "Undone Wire Hud Indicator" )

	// HUD Indicator stuff
	language12.Add( "ToolWireHudIndicator_showinhud", "Show in my HUD")
	language12.Add( "ToolWireHudIndicator_hudheaderdesc", "HUD Indicator Settings:")
	language12.Add( "ToolWireHudIndicator_huddesc", "Description:")
	language12.Add( "ToolWireHudIndicator_hudaddname", "Add description as Name")
	language12.Add( "ToolWireHudIndicator_hudaddnamedesc", "Also adds description as name of indicator (like Wire Namer)")
	language12.Add( "ToolWireHudIndicator_hudshowvalue", "Show Value as:")
	language12.Add( "ToolWireHudIndicator_hudshowvaluedesc", "How to display value in HUD readout along with description")
	language12.Add( "ToolWireHudIndicator_hudx", "HUD X:")
	language12.Add( "ToolWireHudIndicator_hudxdesc", "X of the upper-left corner of HUD display")
	language12.Add( "ToolWireHudIndicator_hudy", "HUD Y:")
	language12.Add( "ToolWireHudIndicator_hudydesc", "Y of the upper-left corner of HUD display")
	language12.Add( "ToolWireHudIndicator_hudstyle", "HUD Style:")
	language12.Add( "ToolWireHudIndicator_allowhook", "Allow others to hook")
	language12.Add( "ToolWireHudIndicator_allowhookdesc", "Allows others to hook this indicator with right-click")
	language12.Add( "ToolWireHudIndicator_hookhidehud", "Allow HideHUD on hooked")
	language12.Add( "ToolWireHudIndicator_hookhidehuddesc", "Whether your next hooked indicator will be subject to the HideHUD input of that indicator")
	language12.Add( "ToolWireHudIndicator_fullcircleangle", "Start angle for full circle gauge (deg):")
	language12.Add( "ToolWireHudIndicator_registeredindicators", "Registered Indicators:")
	language12.Add( "ToolWireHudIndicator_deleteselected", "Unregister Selected Indicator")
end
