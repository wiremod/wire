...
if ( CLIENT ) then
	language12.Add( "Tool_wire_explosive_name", "Wired Explosives Tool" )
	language12.Add( "Tool_wire_explosive_desc", "Creates a variety of different explosives for wire system." )
	language12.Add( "Tool_wire_explosive_0", "Left click to place the bomb. Right click update." )
	language12.Add( "WireExplosiveTool_Model", "Model:" )
	language12.Add( "WireExplosiveTool_modelman", "Manual model selection:" )
	--language12.Add( "WireExplosiveTool_usemodelman", "Use manual model selection:" )
	language12.Add( "WireExplosiveTool_Effects", "Effect:" )
	language12.Add( "WireExplosiveTool_tirgger", "Trigger value:" )
	language12.Add( "WireExplosiveTool_damage", "Damage:" )
	language12.Add( "WireExplosiveTool_delay", "On fire time (delay after triggered before explosion):" )
	language12.Add( "WireExplosiveTool_delayreload", "Delay after explosion before it can be triggered again:" )
	language12.Add( "WireExplosiveTool_remove", "Remove on explosion" )
	language12.Add( "WireExplosiveTool_doblastdamage", "Do blast damage" )
	language12.Add( "WireExplosiveTool_affectother", "Damaged/moved by other wired explosives" )
	language12.Add( "WireExplosiveTool_notaffected", "Not moved by any phyiscal damage" )
	language12.Add( "WireExplosiveTool_radius", "Blast radius:" )
	language12.Add( "WireExplosiveTool_freeze", "Freeze" )
	language12.Add( "WireExplosiveTool_weld", "Weld" )
	language12.Add( "WireExplosiveTool_noparentremove", "Don't remove on parent remove" )
	language12.Add( "WireExplosiveTool_nocollide", "No collide all but world" )
	language12.Add( "WireExplosiveTool_maxhealth", "Max health:" )
	language12.Add( "WireExplosiveTool_weight", "Weight:" )
	language12.Add( "WireExplosiveTool_bulletproof", "Bullet proof" )
	language12.Add( "WireExplosiveTool_explosionproof", "Explosion proof" )
	--language12.Add( "WireExplosiveTool_fallproof", "Fall proof" )
	language12.Add( "WireExplosiveTool_explodeatzero", "Explode when health = zero" )
	language12.Add( "WireExplosiveTool_resetatexplode", "Reset health then" )
	language12.Add( "WireExplosiveTool_fireeffect", "Enable fire effect on triggered" )
	language12.Add( "WireExplosiveTool_coloreffect", "Enable color change effect on damage" )
	language12.Add( "WireExplosiveTool_invisibleatzero", "Become invisible when health reaches 0" )
	language12.Add( "Undone_WireExplosive", "Wired Explosive undone" )
	language12.Add( "sbox_maxwire_explosive", "You've hit wired explosives limit!" )
end
